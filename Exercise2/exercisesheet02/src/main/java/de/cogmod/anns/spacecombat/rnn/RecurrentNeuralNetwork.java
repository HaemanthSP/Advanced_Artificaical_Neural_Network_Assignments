...
import de.cogmod.anns.misc.LearningListener;
import de.cogmod.anns.misc.Tools;
...
public class RecurrentNeuralNetwork {
    ...
    public double[][][][] getDWeights() { return this.dweights; }
    ...
    /**
     * Maps a flat 1D array onto a structured 4D array 
     * (assuming the same overall number of values).
     */
    ...
    /**
     * Maps a structured 4D array onto a flat 1D array.  
     * (assuming the same overall number of values).
     */
    private static void map(final double[][][][] from, final double[] to) {
        int idx = 0;
